...
${OBJECTDIR}/BVH.o: nbproject/Makefile-${CND_CONF}.mk BVH.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BVH.o BVH.cpp

${OBJECTDIR}/BoundingBox.o: nbproject/Makefile-${CND_CONF}.mk BoundingBox.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BoundingBox.o BoundingBox.cpp
...
${OBJECTDIR}/tiny_obj_loader.o: nbproject/Makefile-${CND_CONF}.mk tiny_obj_loader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tiny_obj_loader.o tiny_obj_loader.cpp
